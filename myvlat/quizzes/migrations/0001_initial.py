# Generated by Django 3.2 on 2021-06-22 04:07
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Result',
            fields=[
                ('result_id', models.SmallIntegerField(primary_key=True, serialize=False, verbose_name='result_id')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chart', models.CharField(blank=True, max_length=256, null=True, verbose_name='시각화그래프')),
        ...
        migrations.CreateModel(
            name='Answer',
            fields=[
                ('choice_id', models.SmallIntegerField(primary_key=True, serialize=False, verbose_name='choice_id')),
                ('choice', models.CharField(max_length=64, verbose_name='답안')),
                ('status', models.BooleanField(verbose_name='정답여부')),
                ('quiz_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='quizzes.quiz', verbose_name='quiz_id')),
                ('set_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='quizzes.set', verbose_name='set_id')),
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='quizzes.user', verbose_name='user_id')),
            ],
            options={
