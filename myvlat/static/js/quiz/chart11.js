...
// The svg
var svg = d3.select("#vlat11").append("svg")
...
d3.queue()
.defer(d3.json, "https://raw.githubusercontent.com/nini12091/vlat/main/vlat11_korea.json")
.defer(d3.csv, "https://raw.githubusercontent.com/nini12091/vlat/80d99b9180c4233913bc51915c5e1d7755d804c4/vlat11.csv", function(d) { data.set(d.name, +d.loss); })
.await(ready);
